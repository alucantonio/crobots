/* First two lines are for */
/* Crobots Amiga compatibility */
/*
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$I$?~  ~~II$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$     ,???$$???,,    I$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
Zeroth Law. A robot cannot cause harm to humanity or, by inaction, allow
humanity to come to harm.

ATTENTION

THIS C-ROBOT IS MADE OF 100% BITS
IN THE UNLIKELY EVENT THAT IT COMES INTO CONTACT WITH ANTI-BITS OF ANY KIND, AN EXPLOSION WILL OCCUR

WARNING

THE ENTIRE UNIVERSE (INCLUDING THIS C-ROBOT) MIGHT SOMEDAY COLLAPSE INTO AN INFINITELY SMALL POINT
IF ANOTHER UNIVERSE WERE TO EMERGE, THE EXISTENCE (AND FUNCTIONING) OF THIS C-ROBOT IN THAT UNIVERSE CANNOT BE GUARANTEED
*/

int ang, range, dir, posx, posy, x, y, deg1, timer, clock;

degree(xx,yy) /* Direction to xx,yy */
int xx,yy;
{
    return(dir=(360+((xx-=loc_x())<0)*180+atan(((yy-loc_y())*100000)/xx)));
}

dista(dx,dy) /* Square distance (avoid sqrt()) */
int dx,dy;
{
...
main()
{
    ...
    t,
    d,      /* current damage */
    dave,   /* Dave, I am afraid I cannot do that... */
    attack; /* 2 bits variable */
